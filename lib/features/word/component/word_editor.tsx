    ...
    >
      ...
      <section className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5">
          <div className="mx-auto flex w-full max-w-[1100px] gap-5">
            <div className="min-w-0 flex-1">
              <EditorContent editor={editor} />
            </div>

            <aside className="hidden w-[250px] shrink-0 xl:block">
              <div className="sticky top-5 space-y-4 rounded-3xl border border-[#222426] bg-[#121315] p-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.22em] text-[#7a7d82]">
                    Status
                  </p>
                  <div className="mt-2 space-y-1 text-sm text-[#e8e9ea]">
                    <p>{activeStats.words} words</p>
                    <p>{activeStats.characters} characters</p>
                    <p>
                ...
                <div className="rounded-2xl border border-[#222426] bg-[#17181a] p-4 text-sm text-[#7a7d82]">
                  Tips:
                  <ul className="mt-2 space-y-2">
                    <li>Use the toolbar for formatting.</li>
                    <li>Save keeps the draft in local storage.</li>
                    <li>Download exports a Word-compatible `.rtf` file.</li>
                  </ul>
                </div>
              </div>
            </aside>
